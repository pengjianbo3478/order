package com.gl365.order.quickpayment.web;
...
public class FftOrderController {

	private static final Logger LOG = LoggerFactory.getLogger(FftOrderController.class);
